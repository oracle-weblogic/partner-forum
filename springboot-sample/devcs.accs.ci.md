...
Both way deploys Spring Boot sample application on Application Container Cloud Service. You can check that the deployment was successful by logging to the dashboard and selecting Service Console on Application Container Cloud Service.  The Deployment may take even up to 5 minutes.
...
Continue with [Using Eclipse IDE (Oracle Enterprise Pack for Eclipse) with Oracle Developer Cloud Service](../oepe/setup.oepe.md)
